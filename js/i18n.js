...
const i18n = {
  zh: {
    ...
    // Privacy Policy
    footerPrivacy: '隐私政策 / Privacy Policy',
    privacyTitle: '隐私政策',
    privacyDate: '最后更新日期：2026年6月1日',
    privacyH1: '1. 信息收集',
    privacyP1: '本网站为永劫无间玩家教学社区，我们重视您的隐私。当您使用本站留言板时，我们可能会收集您主动提供的昵称和留言内容。除此之外，我们不会主动收集任何个人身份信息。',
    privacyH2: '2. Cookie 与本地存储',
    privacyP2: '本网站使用浏览器的本地存储（LocalStorage）来保存您的语言偏好设置和留言板昵称，以提升您的使用体验。这些数据仅存储在您的设备上，不会上传到服务器。本网站不使用追踪型 Cookie。',
    privacyH3: '3. 第三方服务',
    privacyP3: '本网站使用以下第三方服务，它们可能收集您的相关信息：',
    privacyP3a: '<strong>Google Fonts</strong> — 提供网页字体。Google 可能收集字体请求相关的技术数据（如 IP 地址）。详见 <a href="https://policies.google.com/privacy" target="_blank" rel="noopener">Google 隐私政策</a>。',
    privacyP3b: '<strong>Google AdSense</strong> — 本网站可能展示 Google 广告。Google 使用 Cookie 来投放个性化广告。您可以随时通过 <a href="https://adssettings.google.com" target="_blank" rel="noopener">Google 广告设置</a> 管理您的广告偏好。详见 <a href="https://policies.google.com/technologies/ads" target="_blank" rel="noopener">Google 广告技术说明</a>。',
    privacyH4: '4. 信息使用目的',
    privacyP4: '我们收集的信息仅用于：留言板功能正常运行、改善网站内容和用户体验、以及遵守法律法规要求。我们不会将您的信息出售、出租或分享给第三方用于其独立营销目的。',
    privacyH5: '5. 数据安全',
    privacyP5: '留言板数据存储在浏览器的 LocalStorage 中，仅限于您个人查看和使用。我们建议不要在留言中分享个人敏感信息（如真实姓名、地址、电话等）。',
    privacyH6: '6. 儿童隐私',
    privacyP6: '本网站不面向 13 岁以下儿童。我们不会故意收集儿童的个人信息。如果您是家长或监护人并发现您的孩子向我们提供了个人信息，请联系我们，我们将尽快删除相关数据。',
    privacyH7: '7. 您的权利',
    privacyP7: '您可以随时清除浏览器缓存和 LocalStorage 来删除本地数据。对于 Google AdSense 的个性化广告，您可以通过 Google 广告设置管理偏好或选择退出。',
    privacyH8: '8. 政策更新',
    privacyP8: '我们可能会不时更新本隐私政策。更新后的政策将在本页面发布，重大变更可能会通过网站公告通知。',
    privacyH9: '9. 联系我们',
    privacyP9: '如果您对本隐私政策有任何疑问，请通过 GitHub Issues 联系我们：<a href="https://github.com/rjzdy123/rjzdy123.github.io/issues" target="_blank" rel="noopener">提交问题</a>。',
  },
  ...
  en: {
    ...
    privacyDate: 'Last Updated: June 1, 2026',
    privacyH1: '1. Information Collection',
    privacyP1: 'This is a NARAKA: BLADEPOINT player teaching community. We value your privacy. When you use our message board, we may collect the nickname and message content you voluntarily provide. Beyond that, we do not actively collect any personally identifiable information.',
    privacyH2: '2. Cookies & Local Storage',
    privacyP2: 'This website uses browser LocalStorage to save your language preference and message board nickname for a better user experience. This data is stored only on your device and is not uploaded to any server. This website does not use tracking cookies.',
    privacyH3: '3. Third-Party Services',
    privacyP3: 'This website uses the following third-party services which may collect relevant data:',
    privacyP3a: '<strong>Google Fonts</strong> — Provides web fonts. Google may collect technical data related to font requests (such as IP address). See <a href="https://policies.google.com/privacy" target="_blank" rel="noopener">Google Privacy Policy</a>.',
    privacyP3b: '<strong>Google AdSense</strong> — This website may display Google advertisements. Google uses cookies to serve personalized ads. You can manage your ad preferences at any time through <a href="https://adssettings.google.com" target="_blank" rel="noopener">Google Ad Settings</a>. See <a href="https://policies.google.com/technologies/ads" target="_blank" rel="noopener">Google Ad Technology</a>.',
    privacyH4: '4. Purpose of Information Use',
    privacyP4: 'The information we collect is used solely for: ensuring the message board functions properly, improving website content and user experience, and complying with legal and regulatory requirements. We do not sell, rent, or share your information with third parties for their independent marketing purposes.',
    privacyH5: '5. Data Security',
    privacyP5: 'Message board data is stored in your browser\'s LocalStorage and is only accessible to you. We recommend not sharing personal sensitive information (such as real name, address, phone number, etc.) in your messages.',
    privacyH6: '6. Children\'s Privacy',
    privacyP6: 'This website is not directed at children under the age of 13. We do not knowingly collect personal information from children. If you are a parent or guardian and discover that your child has provided us with personal information, please contact us and we will promptly delete such data.',
    privacyH7: '7. Your Rights',
    privacyP7: 'You can clear your browser cache and LocalStorage at any time to delete local data. For Google AdSense personalized ads, you can manage your preferences or opt out through Google Ad Settings.',
    privacyH8: '8. Policy Updates',
    privacyP8: 'We may update this Privacy Policy from time to time. Updated policies will be posted on this page, and significant changes may be announced via website notices.',
    privacyH9: '9. Contact Us',
    privacyP9: 'If you have any questions about this Privacy Policy, please contact us via GitHub Issues: <a href="https://github.com/rjzdy123/rjzdy123.github.io/issues" target="_blank" rel="noopener">Submit an Issue</a>.',
  }
};
